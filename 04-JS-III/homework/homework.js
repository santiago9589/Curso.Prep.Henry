...
function empiezaConNueve(n) {
  ...
  stringIngresado=n.toString()

  for(i=0;i<stringIngresado.length;i++)
  {
    if(stringIngresado[i]==='9' && i===0)
    {
      return true;
    }
  }
...
function mesesDelAño(array) {
  ...
  Error="No se encontraron los meses pedidos";
